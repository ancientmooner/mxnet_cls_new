...
namespace mxnet {
namespace op {
DMLC_REGISTER_PARAMETER(ModulatedDeformableConvolutionOldParam);

template<>
Operator* CreateOp<cpu>(ModulatedDeformableConvolutionOldParam param, int dtype,
                        std::vector<TShape> *in_shape,
                        std::vector<TShape> *out_shape,
                        Context ctx) {
  Operator *op = NULL;
  MSHADOW_REAL_TYPE_SWITCH(dtype, DType, {
    op = new ModulatedDeformableConvolutionOldOp<cpu, DType>(param);
  })
  return op;
}

// DO_BIND_DISPATCH comes from operator_common.h
Operator *ModulatedDeformableConvolutionOldProp::CreateOperatorEx(Context ctx,
                                            std::vector<TShape> *in_shape,
...
MXNET_REGISTER_OP_PROPERTY(_contrib_ModulatedDeformableConvolutionOld, ModulatedDeformableConvolutionOldProp)
...
.add_arguments(ModulatedDeformableConvolutionOldParam::__FIELDS__());
